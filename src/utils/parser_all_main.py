...
if __name__ == "__main__":
    ...
    for shop in shops_data:
        ...
        _, orders_count = get_all_orders_by_shop_id(int(shop.etsy_shop_id), shop.shop_id, limit=1)
        log.info(f"Orders in shop {orders_count}")
        offset = 0
        while offset < orders_count:
            shop_orders, _ = get_all_orders_by_shop_id(int(shop.etsy_shop_id), shop.shop_id, offset=offset)
